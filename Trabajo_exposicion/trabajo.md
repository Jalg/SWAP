...
![im1] (/Trabajo_exposicion/Imagenes/im1.png)
...
![im2] (/Trabajo_exposicion/Imagenes/im2.png)
...
![im3] (/Trabajo_exposicion/Imagenes/im3.png)
...
![im4] (/Trabajo_exposicion/Imagenes/im4.png)
...
![im5] (/Trabajo_exposicion/Imagenes/im5.png)
...
![im6] (/Trabajo_exposicion/Imagenes/im6.png)

A continuación mostramos algunas Imagenes sobre algunas de las opciones de web admin.
Por ejemplo proporciona información del dispositivo, como que CPU tiene, la memoria o información sobre la batería.

![im7] (/Trabajo_exposicion/Imagenes/im7.png)

También información sobre el estado de la conexión.

![im8] (/Trabajo_exposicion/Imagenes/im8.png)

O información importante de nuestro servidor.

![im9] (/Trabajo_exposicion/Imagenes/im9.png) 
...
![im10] (/Trabajo_exposicion/Imagenes/im10.png) 
...
![im11] (/Trabajo_exposicion/Imagenes/im11.png) 

Según powertutor.

![im12] (/Trabajo_exposicion/Imagenes/im12.png) 
...
![im13] (/Trabajo_exposicion/Imagenes/im13.png) 

Damos a *start server* para iniciar el servidor. 

![im14] (/Trabajo_exposicion/Imagenes/im14.png)
...
![im15] (/Trabajo_exposicion/Imagenes/im15.png)
...
Recién instalado nos salen varios mensajes avisándonos de que una versión de prueba. Vamos a mostrar algunas Imagenes de sus funcionalidades o 
de la multitud de herramientas con las que puede llegar a trabajar. 

![im16] (/Trabajo_exposicion/Imagenes/im16.png)

![im17] (/Trabajo_exposicion/Imagenes/im17.png)
...
![im18] (/Trabajo_exposicion/Imagenes/im18.png)
...
![im19] (/Trabajo_exposicion/Imagenes/im19.png)

Probamos que funciona accediendo a la raíz del server.

![im20] (/Trabajo_exposicion/Imagenes/im20.png)
...
![im21] (/Trabajo_exposicion/Imagenes/im21.png)
...
![im22] (/Trabajo_exposicion/Imagenes/im22.png)

![im23] (/Trabajo_exposicion/Imagenes/im23.png)
