...
![im7] (/Practicas/Practica3/Imagenes/im7.png)

		
Quedando como mostramos anteriormente. Después editamos el archivo /etc/default/pound cambiando startpup a 1 para poder arrancarlo.

![im8] (/Practicas/Practica3/Imagenes/im8.png)

Para que inicie introducimos la orden /etc/init.d/pound start.
Y por último llamamos al balanceador desde la máquina 4 como hemos hecho que las otras dos configuraciones.

![im9] (/Practicas/Practica3/Imagenes/im9.png)
